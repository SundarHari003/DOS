  ...
  return (
    <div className=''>
        <footer className='min-h-screen bg-gradient-to-r from-blue-600 to-green-500 rounded-t-3xl w-full flex flex-wrap justify-center items-center md:justify-normal md:items-start text-white'>
            ...
            <div className=' w-5/6 md:w-2/4 flex flex-col justify-center'>
              ...
              <div className=' flex items-center m-10 w-full ms-0' data-aos="fade-right" data-aos-delay="200">
                ...
                <label htmlFor="email" className=' relative -left-12 rounded-e-full cursor-pointer'><GrSend size={35}/></label>
              </div>
