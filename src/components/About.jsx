    ...
    <div className=' relative top-20'>
        <div className=' min-h-screen w-full rounded-3xl '>
            ...
            <div className=' flex gap-8 w-full justify-center items-center mt-12 flex-wrap mb-10'>
                <div data-aos="fade-down" data-aos-delay='100' className=' w-3/4 sm:w-2/4 lg:w-1/4 flex items-center flex-col border-2 border-white hover:border-green-500 border-dotted rounded-lg'>
                ...
                <div data-aos="fade-down" data-aos-delay='200' className=' w-3/4 sm:w-2/4 lg:w-1/4 flex flex-col items-center border-2 border-white hover:border-green-500 border-dotted rounded-lg'>
